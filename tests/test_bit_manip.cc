        ...
        unsigned int, long, unsigned long, long long, unsigned long long)
{
    ...
    auto x = gul::bit_set<TestType>(msb);
    ...
    REQUIRE(gul::bit_test(x, msb) == true);
    REQUIRE(gul::bit_test(x, msb - 1) == false);
}
